                        ...
                        <CardContent>
                                ...
                                {!showForm ? (
                                                        ...
                                                        {slots.length === 0 ? (
                                                                ...
                                                                <div className="space-y-3">
                                                                        {slots.map((slot) => (
                                                                                <div
                                                                                        key={slot.id}
                                                                                        className="flex items-center p-3 rounded-md bg-muted/20 border border-amber-900/20"
                                                                                >
                                        ...
                                        <form
                                                ...
                                                className="space-y-4 border border-amber-900/20 rounded-md p-4"
                                        >
                                ...
                                <div className="mt-6 p-4 bg-muted/10 border border-amber-900/10 rounded-md">
