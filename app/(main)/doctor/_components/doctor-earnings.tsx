                ...
                <div className="space-y-6">
                        ...
                        <Card className="border-amber-900/20 bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800">
                                ...
                                <CardContent className="space-y-4">
                                        ...
                                        <div className="bg-muted/20 p-4 rounded-lg border border-amber-900/20">
                                        ...
                                        {/* Payout Information */}
                                        <Alert className="bg-gradient-to-br from-slate-600 via-slate-700 to-slate-800">
                                                <AlertCircle className="h-4 w-4" />
                                                <AlertDescription className="text-sm ">
                                                ...
                                                <div className="space-y-2">
                                                        ...
                                                        <div className="space-y-2">
                                                                {payouts.slice(0, 5).map((payout) => (
                                                                        <div
                                                                                key={payout.id}
                                                                                className="flex items-center justify-between p-3 rounded-md bg-muted/10 border border-amber-900/10"
                                                                        >
                                                                                <div>
                                                                                        <p className="text-white font-medium">
                                ...
                                <DialogContent>
                                        ...
                                        <form onSubmit={handlePayoutRequest} className="space-y-4">
                                                <div className="bg-muted/20 p-4 rounded-lg space-y-2">
                                                        ...
                                                        <div className="border-t border-amber-900/20 pt-2 flex justify-between font-medium">
                                                ...
                                                <div className="space-y-2">
                                                        ...
                                                        <Input
                                                                ...
                                                                className="bg-background border-amber-900/20"
                                                                required
                                                        />
                                                        <p className="text-sm text-muted-foreground">
