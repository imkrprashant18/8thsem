        ...
        return (
                <div className=" px-4 py-12 w-full  bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 -mt-4">
                        ...
                        <div className="flex justify-start mb-2">
                                <Link
                                        href="/"
                                        className="flex items-center text-amber-400 hover:text-white transition-colors cursor-pointer"
                                >
                        ...
                        <div className="max-w-full mx-auto mb-12 text-center">
                                <Badge
                                        variant="outline"
                                        className="bg-amber-900/30 border-amber-700/30 px-4 py-1 text-amber-400 text-sm font-medium mb-4"
                                >
